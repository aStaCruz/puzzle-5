...
ApplicationWindow {
    ...
    property variant bands: ["TODD BREEDLOVE", "BUBA THE LARGEST MAN EVER", "Dance Gavin Dance", "LOSER SAY WHAT?"]
                ...
                MouseArea
                {
                    ...
                    onClicked:
                    {
                        ...
                        else
                        {
                            ...
                            txt_screen_song.text = "Paused Song: " + songs[song_index]
                            txt_screen_band.text = "Paused Band: " + bands[song_index]
                            song_current.pause(); //step b
